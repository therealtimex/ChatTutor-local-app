...
:::warning 方案已废弃
本文档描述的技术方案（包括 DSL、Painter Agent、响应式变量等）已经废弃。当前版本的 ChatTutor 已不再使用这些技术。本文档仅作为历史记录保留。
:::
...
- GitHub [@HugeCatLab](https://github.com/HugeCatLab)
...
GitHub: [https://github.com/HugeCatLab/ChatTutor](https://github.com/HugeCatLab/ChatTutor)
